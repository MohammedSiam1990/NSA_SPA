...
var successCallBack = function (data) {
    ...
    grid = $("#grid").kendoGrid({
        ...
        search: {
            fields: ["CreateDateS", "TaxName", "TaxNameAr", $Lang === 'ar' ? "StatusNameAr" : "StatusName", "LastName"]
        },
        pageable: {
            refresh: true,
            buttonCount: 5,
