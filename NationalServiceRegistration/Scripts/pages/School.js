...
function Fill_SchoolSocialStatus() {

    var Lang = sessionStorage['lang'];

    var DataSource_SchoolSocialStatus = new kendo.data.DataSource({ data: data_SchoolSocialStatus });
    try {


        $("#SchoolSocialStatus").kendoDropDownList({
            dataTextField: Lang === 'ar' ? "NameAr" : "Name",
            dataValueField: "id",
            template: Lang === 'ar' ? '<i class="#:data.Flag # flag"></i> ' + '#:data.NameAr #' : '<i class="#:data.Flag # flag"></i> ' + '#:data.Name #',
            dataSource: DataSource_SchoolSocialStatus,
            filter: "contains",
            suggest: true,
            index: 3
...
function Fill_SchoolBloodType() {
    ...
    var DataSource_SchoolBloodType = new kendo.data.DataSource({ data: data_SchoolBloodType });

    $("#SchoolBloodType").kendoDropDownList({
        dataTextField: Lang === 'ar' ? "NameAr" : "Name",
        dataValueField: "id",
        template: Lang === 'ar' ? '<i class="#:data.Flag # flag"></i> ' + '#:data.NameAr #' : '<i class="#:data.Flag # flag"></i> ' + '#:data.Name #',
        dataSource: DataSource_SchoolBloodType,
        filter: "contains",
        suggest: true,
        index: 3
...
function Fill_Reasons_Postponement_Exemption_Requirements() {
    ...
    $("#School_Delay_Exemption_Exception").kendoDropDownList({
        dataTextField: Lang === 'ar' ? "NameAr" : "Name",
        dataValueField: "id",
        template: Lang === 'ar' ? '<i class="#:data.Flag # flag"></i> ' + '#:data.NameAr #' : '<i class="#:data.Flag # flag"></i> ' + '#:data.Name #',
...
function ready_Page() {
    ...
    if (sessionStorage['IsSuperAdmin'] != 'true') {
        ...
        $(".next").click(function () {
            ...
            if (current == 7 && $('#IsAddDelay_Exemption_Exception').is(':checked') == true && ($('#School_Delay_Exemption_Exception').val() == '' || $('#ImageName_other').val() == '')) {

                $('#ResultMessage').addClass('alert-danger show');
                $('#ResultTxt').html(DBSTRING['lblphotos_School_Delay_Exemption_Exception']);
                setTimeout("$('#ResultMessage').removeClass('show')", 2000);
                return false;
            }
        ...
        if ((CheckPageSoldier() == true || CheckPageUniversity() == true)) {
        ...
        $("#SchoolBrithDayDate").kendoDatePicker({
        ...
        if (!Edit) {
            $('#SaveSchool').hide();
            $(':input, select ', '#SchoolForm').attr('disabled', true);
            DisabledEnableKendoDropDownByForm('SchoolForm', false)
    ...
    BindFileUploaderkendoSchool();
    FillDBSTRINGPage('SchoolForm');
...
function FillLabel_lblphotos_School_Delay_Exemption_Exception(value) {
    switch (value) {
        case "1":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'قرار من اللجنة الطبية العسكرية';
            break;
        case "6" || "7":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'من عند الوزير او من يوفوضه';
            break;
        case "8":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'شهادة دورة تاسيسية + اثبات عمل';
            break;
        case "9":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'شهادة دورة تاسيسية + اخلاء طرف من الجهة العسكرية موضح عدد سنوات الخدمة';
            break;
        case "10":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'شهادة دورة تاسيسية + اثبات عمل ';
            break;
        case "11":
            ...
            break;
        case "12":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'شهادة وفاه من وزارة الصحة';
            break;
        case "13":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'موافقه او صلاحية تجنيد من الوزير او الجهه العسكرية';
            break;
        case "14":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'شهادة دورة تاسيسية + اخلاء طرف من الجهة العسكرية موضح عدد سنوات الخدمة';
            break;
        case "15":
            ...
            break;
        case "16":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات عدم زواج الاخوات اثبات عدم وجود رب للاسره';
            break;
        case "17":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'إذا كانت ارملة او مطلقةبائناً او كان زوجها عاجز عن الكسب';
            break;
        case "18":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'بشرط يكون الاب عاجزاً صحياً او عاجزاً عن الكسب';
            break;
        case "19":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات عدم زواج الاخوات اثبات عدم وجود عائل للاسره';
            break;
        case "20":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات من الجهة المختصة بأسر الاب + اثبات عدم عمل الاخوه';
            break;
        case "21":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات من المحكمة بفقدان الاب + اثبات عدم عمل الاخوه';
            break;
        case "22" || "23" || "24" || "25":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'كتاب من الجوازات موضح فية عدد افراد الاسره';
            break;
        case "26":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اذا كان لدية اخ مقعد غير قادر على خدمة نفسه';
            break;
        case "27":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'شهادة وفاه الزوحة + كتاب من الجوازات موضح فية عدد افراد الاسره';
            break;
        case "28" || "29":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات من المحكمة';
            break;
        case "30":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'كتاب من مركز معلومات الطلبة / ن لا يزيد21 سنة';
            break;
        case "31":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'قبول غير مشروط / ن لا يزيد28 سنة';
            break;
        case "32":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'قبول غير مشروط';
            break;
        case "33":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'قبول طب غير مشروط';
            break;
        case "34":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'شهاده قيد من الجامعة + كشف درجات ';
            break;
        case "35":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات بالدراسة قبل سريان احكام القانون ان لا يزيد 25 سنة ';
            break;
        case "36":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات بالدراسة قبل سريان احكام القانون ان لا يزيد 28 سنة ';
            break;
        case "37":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات من التعليم او الجامعة';
            break;
        case "38" || "40":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات من وزارة العمل';
            break;
        case "39" || "42":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات من وزارة التعليم والتعليم العالى';
            break;
        case "41" || "43" || "44":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'اثبات من وزارة الصحة';
            break;
        case "45":
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'مرفقات اخرى';
            $('#Notes_Other').attr('disabled', false);
            break;
        default:
            document.getElementById("lblphotos_School_Delay_Exemption_Exception").innerHTML = 'لايوجد مرفق';
            break;
    }
}
...
function dropdownlist_change(e) {
    ...
    FillLabel_lblphotos_School_Delay_Exemption_Exception(value);
...
function api_call() {
    ...
    var Lang = sessionStorage['lang'];
    var URL = $URL_School + "GetSchoolById?InsertedBy=" + InsertedBy + "&&Lang=" + Lang;
    $.ajax({
        type: 'Get',
        url: URL,
        headers: {
...
function api_callAddmin(data) {
    ...
    $('#SchoolForm').attr('disabled', false);
    ...
    if (data.datalist.school_Delay_Exemption_Exception == '45') {
        $('#Notes_Other').attr('disabled', false);
    }
    ...
    $('#SchoolId').val(data.datalist.schoolId);
    $('#SchoolName1').val(data.datalist.schoolName1);
    $('#SchoolName2').val(data.datalist.schoolName2);
    $('#SchoolName3').val(data.datalist.schoolName3);
    $('#SchoolName4').val(data.datalist.schoolName4);
    ...
    $('#SchoolAverage').val(data.datalist.schoolAverage);





    $('#SchoolMobile1').val(data.datalist.schoolMobile1);
    $('#SchoolMobile2').val(data.datalist.schoolMobile2);
    $('#SchoolPhoneHome').val(data.datalist.schoolPhoneHome);
    $('#SchoolFax').val(data.datalist.schoolFax);
    $('#SchoolMobileFriend').val(data.datalist.schoolMobileFriend);
    $("#SchoolBrithDayDate").kendoDatePicker({ value: data.datalist.schoolBrithDayDate });
    ...
    $('#SchoolEmployer').val(data.datalist.schoolEmployer);
    $('#SchoolTypeWork').val(data.datalist.schoolTypeWork);
    $('#SchoolPhoneWork').val(data.datalist.schoolPhoneWork);
    $('#SchoolFaxWork').val(data.datalist.schoolFaxWork);
    $('#SchoolAddressWork').val(data.datalist.schoolAddressWork);
    $('#SchoolZone').val(data.datalist.schoolZone);
    $('#SchoolStreetName').val(data.datalist.schoolStreetName);
    $('#SoliderHomeNo').val(data.datalist.soliderHomeNo);


    FillLabel_lblphotos_School_Delay_Exemption_Exception(JSON.stringify(data.datalist.school_Delay_Exemption_Exception));
    ...
    $dataForm = $('#SchoolForm').serializeArray();
...
var FillForm = function (data) {
    ...
    var Lang = sessionStorage['lang'];
    var URL = $URL_School + "GetSchoolBySchoolID?SchoolId=" + SchoolId + "&&Lang=" + Lang;
    $.ajax({
        type: 'Get',
        url: URL,
        headers: {
...
var successCallBack = function (data) {
    ...
    var dropdownlist = $("#SchoolSocialStatus").data("kendoDropDownList");
    dropdownlist.value(data.datalist.schoolSocialStatus);

    var ddlSchoolBloodType = $("#SchoolBloodType").data("kendoDropDownList");
    ddlSchoolBloodType.value(data.datalist.schoolBloodType);
    ...
    var ddlSchool_Delay_Exemption_Exception = $("#School_Delay_Exemption_Exception").data("kendoDropDownList");
    ddlSchool_Delay_Exemption_Exception.value(data.datalist.school_Delay_Exemption_Exception);
...
var SaveSchool = function (next) {
    ...
    jconfirmSave(DBSTRING['MadeChangeFormNotSave'], DBSTRING['Save'], function (r) {
        if (r === 1) { //Ok
            ...
            var obj = {
                "SchoolId": "", "SchoolName1": "", "SchoolName2": "", "SchoolName3": "", "SchoolName4": "", "SchoolNameEN": "",
                "SchoolQID": "", "SchoolCertificateDegree": "", "SchoolCertificateDegreeDate": "", "SchoolMobile1": "", "SchoolMobile2": "",
                "SchoolPhoneHome": "", "SchoolFax": "", "SchoolMobileFriend": "", "SchoolBrithDayDate": "", "SchoolSocialStatus": "",
                "SchoolBloodType": "", "SchoolEmployer": "", "SchoolTypeWork": "", "SchoolPhoneWork": "",
                "SchoolFaxWork": "", "SchoolAddressWork": "", "SchoolZone": "", "SchoolStreetName": "", "SoliderHomeNo": "",
                ...
                "ImageName_Health": "", "ImageName_married": "", "SchoolSpecialization": "", "SchoolLocation": "", "SchoolAverage": "",
                "School_Delay_Exemption_Exception": "", "IsEmployee": "", "IsAddDelay_Exemption_Exception": "", "ManagementAction": "", "Management_Notes": "", "Ministry": "", "Notes_Other": ""
            };
            ...
            obj.SchoolName1 = $('#SchoolName1').val();
            obj.SchoolName2 = $('#SchoolName2').val();
            obj.SchoolName3 = $('#SchoolName3').val();
            obj.SchoolName4 = $('#SchoolName4').val();
            obj.SchoolNameEN = $('#SchoolNameEN').val();
            obj.SchoolQID = $('#SchoolQID').val();
            obj.SchoolBrithDayDate = $('#SchoolBrithDayDate').val();
            obj.SchoolSocialStatus = $('#SchoolSocialStatus').val();
            obj.SchoolBloodType = $('#SchoolBloodType').val();


            obj.SchoolCertificateDegree = $('#SchoolCertificateDegree').val();
            obj.SchoolCertificateDegreeDate = $('#SchoolCertificateDegreeDate').val();
            obj.SchoolSpecialization = $('#SchoolSpecialization').val();
            obj.SchoolLocation = $('#SchoolLocation').val();
            obj.SchoolAverage = $('#SchoolAverage').val();


            obj.SchoolMobile1 = $('#SchoolMobile1').val();
            obj.SchoolMobile2 = $('#SchoolMobile2').val();
            obj.SchoolPhoneHome = $('#SchoolPhoneHome').val();
            obj.SchoolFax = $('#SchoolFax').val();
            obj.SchoolMobileFriend = $('#SchoolMobileFriend').val();



            obj.SchoolEmployer = $('#SchoolEmployer').val();
            obj.SchoolTypeWork = $('#SchoolTypeWork').val();
            obj.SchoolPhoneWork = $('#SchoolPhoneWork').val();
            obj.SchoolFaxWork = $('#SchoolFaxWork').val();
            obj.SchoolAddressWork = $('#SchoolAddressWork').val();


            obj.SchoolZone = $('#SchoolZone').val();
            obj.SchoolStreetName = $('#SchoolStreetName').val();
            obj.SoliderHomeNo = $('#SoliderHomeNo').val();




            obj.School_Delay_Exemption_Exception = $('#School_Delay_Exemption_Exception').val();
            ...
            if (sessionStorage['IsSuperAdmin'] == 'true') {
                ...
                var URL = $URL_School + "SaveSchool?Lang=" + Lang;
                ...
                if ($('#SchoolId').val() != null && $('#SchoolId').val() != '') {
                    ...
                    var URL = $URL_School + "UpdateSchool?Lang=" + Lang;
                } else {
                    obj.StatusId = 1;
                    obj.SchoolId = 0;
                    obj.InsertedBy = sessionStorage['UserId'];
                    var URL = $URL_School + "AddSchool?Lang=" + Lang;
                }
            }
            $.ajax({
                type: "POST",
