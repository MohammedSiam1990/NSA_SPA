...
$(document).ready(function () {
    ...
    /*    FillDBSTRINGPage('ApproveRejectSoldierForm');*/
    successCallBack('');
...
var successCallBack = function (data) {
    ...
    var URL = $URL_ApproveRejectSoldier + "GetProSoldiersAll";
    ...
    grid = $("#grid").kendoGrid({
        ...
        search: {
            fields: ["CreateDateS", "SoldierId", "SoldierQID" , "SoldierNameAr", $Lang === 'ar' ? "StatusNameAr" : "StatusName", "LastName"]
        },
        pageable: {
            refresh: true,
            buttonCount: 5,
